...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Obada Yehia - Admin Dashboard</title>
      ...
      <div class="page-wrapper">
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown user-menu">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li>
                      <a href="{{route('change.password')}}"> <i class="mdi mdi-lock"></i> Change Password </a>
                    </li>
                    <li>
        ...
        <footer class="footer mt-auto">
          <div class="copyright bg-white">
            <p>&copy; <span id="copy-year">2021</span> Copyright Admin Dashboard by <a class="text-primary" href="http://www.facebook.com/obadatech01" target="_blank">Obada Yehia</a>.</p>
          </div>
          <script>
            var d = new Date();
